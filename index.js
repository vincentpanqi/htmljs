...
(function () {
    ...
    black = ['Mail.RU_Bot', 'rogerbot', 'PHP', 'opensiteexplorer', 'SV1', 'sv1', 'istellabot', 'webmeup', 'DNSPod', 'monitor', 'snarfware', 'majestic12', 'easou', 'yunyun', 'sougou', 'sogou', 'yunrang', 'ahrefs', "longurl", 'rogerbot', 'YisouSpider', 'Steeler', 'Yahoo', 'ChinasoSpider'];
